        ...
        c() {
          (t = w("header")),
            ...
            M(
              u,
              "class",
              "text-3xl font-bold flex-grow text-center flex-1"
            ),
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (Y = w("div")),
            (Y.innerHTML =
              '<span class="text-custom-negative"></span> \n                <span class="px-1">🔊🔊🔊</span>'),
            (C = x()),
            Q(O.$$.fragment),
      ...
      c() {
        (t = w("meta")),
          ...
          M(
            t,
            "content",
            "Guess the song! A fork/clone of Heardle."
          ),
          M(h, "class", "flex-none"),
          M(
            k,
